...
#covid
covid_30 <- felm(log(newcaset.2 + 1) ~ log(cumGZ + 1)  + log(agrgt_potecovid_lag2 + 1) + emergency + log(noftestst.2 + 1) +
                   log(customers_per)| pref+week | 0 | pref, data = weekSIR_rob)
covid_30.2 <- felm(log(newcaset.2 + 1) ~ log(cumGZ + 1)  + log(agrgt_potecovid_lag2 + 1) + emergency + log(noftestst.2 + 1) +
                     log(customers_per) + log(avg_temp_q) + log(rain + 1)| pref+week | 0 | pref, data = weekSIR_rob)
covid_30.3 <- felm(log(newcaset.2 + 1) ~ log(linear_rand_ymns + 1) + log(agrgt_potecovid_lag2 + 1) + emergency + log(noftestst.2 + 1) +
                     log(customers_per) + log(avg_temp_q) + log(rain + 1) | pref+week | 0 | pref, data = weekSIR_rob)
covid_30.4 <- felm(log(newcaset.2 + 1) ~ log(linear_rand + 1) + log(agrgt_potecovid_lag2 + 1) + emergency + log(noftestst.2 + 1) +
                     log(customers_per) + log(avg_temp_q) + log(rain + 1) | pref+week | 0 | pref, data = weekSIR_rob)
covid_30.5 <- felm(log(newcaset.2 + 1) ~ log(linear_rand + 1) + weeknum:factor(pref) + log(agrgt_potecovid_lag2 + 1) +
                     emergency + log(noftestst.2 + 1) + log(customers_per) + log(avg_temp_q) + log(rain + 1) | 0 | 0 | pref, data = weekSIR_rob)
covid_30.6 <- felm(log(newcaset.2 + 1) ~ log(cumGZ + 1) + weeknum:factor(pref) + log(agrgt_potecovid_lag2 + 1) +
                     emergency + log(noftestst.2 + 1) + log(customers_per) + log(avg_temp_q) + log(rain + 1) | 0 | 0 | pref, data = weekSIR_rob)
covid_30.7 <- felm(log(newcaset.2 + 1) ~ log(cumGZ + 1) + log(linear_rand + 1) + log(agrgt_potecovid_lag2 + 1) + 
                     emergency + log(noftestst.2 + 1) + log(customers_per) + log(avg_temp_q) + log(rain + 1) | pref+week | 0 | pref, data = weekSIR_rob)
covid_30.8 <- felm(log(newcaset.2 + 1) ~ log(cumGZ + 1) + log(linear_rand_ymns + 1) + log(agrgt_potecovid_lag2 + 1) +
                     emergency + log(noftestst.2 + 1) + log(customers_per) + log(avg_temp_q) + log(rain + 1) | pref+week | 0 | pref, data = weekSIR_rob)
