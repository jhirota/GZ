...
axes.text(pd.Timestamp("2020-07-25"), 12, "The GZ certification \n system started.", color = 'gray')
plt.legend(['Neighboring 5 prefectures', "Yamanashi"])
plt.xlabel("Week")
plt.ylabel("Weekly sales per restaurant [1 million JPY]")
plt.title("Time series of weekly sales per restaurant \n in Yamanashi and neighboring prefectures")
...
axes.axvline(pd.to_datetime('2020-07-17'), color='gray', linestyle='dashed', lw=2)
axes.text(pd.Timestamp("2020-07-25"), 500, "The GZ certification \n system started.", color = 'gray')
plt.legend(['Neighboring 5 prefectures', "Yamanashi"])
plt.xlabel("Week")
plt.ylabel("Number of customers per restaurant in a week")
plt.title("Time series of number of customers per restaurant in a week \n in Yamanashi and neighboring prefectures")
