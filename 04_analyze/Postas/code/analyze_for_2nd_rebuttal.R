...
aic_sales_l0 <- round(AIC(postas_sales_l0), digits = 2)
aic_sales_l1 <- round(AIC(postas_sales_l1), digits = 2)
aic_sales_l2 <- round(AIC(postas_sales_l2), digits = 2)
aic_sales_l3 <- round(AIC(postas_sales_l3), digits = 2)
aic_sales_l4 <- round(AIC(postas_sales_l4), digits = 2)
aic_sales_l5 <- round(AIC(postas_sales_l5), digits = 2)
...
aic_cus_l0 <- round(AIC(postas_cus_l0), digits = 2)
aic_cus_l1 <- round(AIC(postas_cus_l1), digits = 2)
aic_cus_l2 <- round(AIC(postas_cus_l2), digits = 2)
aic_cus_l3 <- round(AIC(postas_cus_l3), digits = 2)
aic_cus_l4 <- round(AIC(postas_cus_l4), digits = 2)
aic_cus_l5 <- round(AIC(postas_cus_l5), digits = 2)
