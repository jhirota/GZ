...
subtitle: "Investigating the epidemiological and economic effects of a third-party certification for restaurants with COVID-19 prevention measures"
...
B. Estimation Equation
  ...
  1. Derivation of the Epidemiological Equation from the SIR model
  2. Model selection of the time lag for the policy effects (AIC)

C. Basic Statistics

  1. Summary statistics of analysis
  2. Cumulative number of the GZ-certified restaurants
  
D. Statistical Testing 

  1. Infection prevention effects (2 week lag analysis)
  2. Infection prevention effects (1 week lag analysis)
  3. Economic effects (restaurants’ sales and the number of customers)
...
## B.1 Derivation of the Epidemiological Equation from the SIR model
...
\blandscape
## B.2 Model selection of the time lag for the policy effects (AIC)
### B.2.1 Model Selection (AIC) for Infection prevention effects: The COVID-19 new infection cases
\input{../../../04_analyze/Covid/output/covid_weekly_AIC.tex}
\fillandplacepagenumber
\elandscape
\newpage

\blandscape
### B.2.2 Model Selection (AIC) for Infection prevention effects: Unit of time series (Weekly and Daily)
\input{../../../04_analyze/Covid/output/covid_weekly_and_daily_AIC.tex}
\fillandplacepagenumber
\elandscape
\newpage

### B.2.3 Model Selection (AIC) for Economic effects: Restaurants' sales (POS) 
\input{../../../04_analyze/Postas/output/postas_sales_AIC.tex}
\newpage

### B.2.4 Model Selection (AIC) for Economic effects: the number of Restaurants' customers (POS)
\input{../../../04_analyze/Postas/output/postas_cus_AIC.tex}
\newpage
...
## D.1  Infection prevention effects (2 week lag analysis)
...
\blandscape
## D.3  Economic effects (restaurants’ sales and the number of customers)
