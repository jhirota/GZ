...
---
   ...
   In this online appendix, we summarize the sub-evidence for the main article. First, we present the data. Second, we describe the derivation of the estimating equation. Third, we cover basic statistics for each variable. Fourth, we cover regression tables for statistical testing. Finally, we provide supplementary information about the treatment effects.
  
# Table of Contents

A. Data 

  1. COVID-19 policy dummies 
  2. COVID-19 test cases 
  3. Restaurant website views 
  4. Mobility by residential type 
  5. Mobility inflow and outflow by prefecture 
  6. Mobility by facility type 
  7. Weather data 
  8. Stay-home rate 
